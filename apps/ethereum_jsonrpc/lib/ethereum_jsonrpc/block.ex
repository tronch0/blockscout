defmodule EthereumJSONRPC.Block do
  ...
  defp entry_to_elixir({key, _} = entry)
       when key in ~w(author extraData hash logsBloom miner mixHash nonce parentHash receiptsRoot sealFields sha3Uncles blockExtraData extDataHash blockGasCost extDataGasUsed blockGasCost extDataGasUsed
